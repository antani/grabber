    ...
    class << self
	    ...
	    def parse_flipkart(page)      			
			...
			prices=[]
                        ...
                        page.search("div.lastUnit div.fk-litems-section:nth-child(2) div.fk-medium-atom img").each do |img|
                        ...
                        name_text = page.search("div.lastUnit div.fk-litems-section:nth-child(3) a.fk-anchor-link").map{ |e| "#{e.content} " }                      
                        author_text = ""
                        img_text = []

                        page.search("div.lastUnit div.fk-litems-section:nth-child(3) img").each do |img|
                            img_text << img.attributes['src'].content
                        end
	    ...
	    def proper_case(str)
            ...
            def movie_info
 		        #@@logger.info("Get Top Movies from Flipkart")
                   	url = "http://www.flipkart.com/movies"
