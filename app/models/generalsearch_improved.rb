...
#                          final_prices = rest_prices + top_prices  
      ...
      #               ###@@logger.info(type)
                     ...
                     req_ebay= Typhoeus::Request.new(url,:timeout=> 10000)      
                     ...
                     if mtype == 'movies' then
                          ...
                          req_moviemart= Typhoeus::Request.new(url,:timeout=> 10000)      
                          ...
                          req_moserbaer= Typhoeus::Request.new(url,:timeout=> 10000)      
                          ...
                          req_indiatimes= Typhoeus::Request.new(url,:timeout=> 10000)      
                     ...
                     if mtype == 'cameras' then
                           ...
                           req_fotocenter= Typhoeus::Request.new(url,:timeout=> 10000)      
                     ...
                     if mtype == 'books' then
                           ...
                           req_rediff= Typhoeus::Request.new(url,:timeout=> 10000)      
              ...
              #            ###@@logger.info(response.time)    # time in seconds the request took 
               ...
               #           ###@@logger.info(response.time)    # time in seconds the request took 
                ...
                #          ###@@logger.info(response.time)    # time in seconds the request took 
                           ...
                           req_coinjoos = Typhoeus::Request.new(url,:timeout=> 10000)      
                ...
                #          ###@@logger.info(response.time)    # time in seconds the request took 
                     ...
                     #Only Mobiles
            		     if mtype == 'mobiles' then
                           ...
                           req_sangeeta = Typhoeus::Request.new(url,:timeout=> 10000)      
                    ...
                    if (mtype =='movies' or mtype =='books') then
                           ...
                           req_landmark = Typhoeus::Request.new(url,:timeout=> 10000)      
